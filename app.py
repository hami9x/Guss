...
app = webapp2.WSGIApplication([
                    ...
                    webapp2.Route("/admin/blog", handler="admin_blog.AdminBlogHandler", name="admin-manage-blog"),
                    webapp2.Route(r"/blog/edit/<slug:[\w-]*>", handler="blog.BlogEditHandler", name="blog-edit"),
                    webapp2.Route(r"/blog/new", handler="blog.BlogEditHandler", name="blog-new"),
                    webapp2.Route(r"/blog/view/<slug:[\w-]*>", handler="blog.BlogViewHandler", name="blog-view"),
                    webapp2.Route(r"/forum/thread/new", handler="forum.ForumThreadEditHandler", name="forumthread-new"),
